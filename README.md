This repository contains the code for the backend of my project. The API has been made in flask using Python. MongoDB Atlas has been used as the database.
